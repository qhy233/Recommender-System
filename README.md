...
### 2. 推荐系统工作原理 ([推荐系统工作原理.md](推荐系统工作原理.md))
...
#### 3.1 综合总结 ([00_强化学习推荐系统论文综合总结.md](00_强化学习推荐系统论文综合总结.md))
...
#### 4.1 强化学习基本概念 ([强化学习基本概念.md](强化学习基本概念.md))
...
#### 4.2 强化学习在推荐系统中的实现方式 ([强化学习在推荐系统中的实现方式.md](强化学习在推荐系统中的实现方式.md))
...
### 5. 用户行为数据处理 ([推荐系统用户行为数据的获取与处理.md](推荐系统用户行为数据的获取与处理.md))
...
基于FunRec开源教材，包含完整的推荐系统学习教程：

### 系统化教程

| 章节 | 内容 |
|------|------|
| [Chapter 0: 推荐系统概述](参考教材/chapter_0_introduction/) | 推荐系统是什么、技术地图 |
| [Chapter 1: 召回模型](参考教材/chapter_1_retrieval/) | 协同过滤、向量召回、序列召回 |
| [Chapter 2: 排序模型](参考教材/chapter_2_ranking/) | Wide & Deep、特征交叉、序列建模、多目标优化 |
| [Chapter 3: 重排模型](参考教材/chapter_3_rerank/) | 贪心方法、个性化重排 |
| [Chapter 4: 难点及热点研究](参考教材/chapter_4_trends/) | 偏差消除、冷启动、生成式推荐 |
| [Chapter 5: 项目实践](参考教材/chapter_5_projects/) | 需求理解、基线建立、召回优化、特征工程 |
| [Chapter 6: 面试经验](参考教材/chapter_6_interview/) | 机器学习基础、推荐系统核心、前沿趋势 |

### 辅助资源

| 资源 | 说明 |
|------|------|
| [img/](参考教材/img/) | 各类模型架构图、算法流程图 |
| [chapter_references/](参考教材/chapter_references/) | 参考文献、相关论文链接 |

## 学习路径建议

### 初学者路径

1. 阅读 [推荐系统工作原理](推荐系统工作原理.md)，建立整体认知
2. 学习 [参考教材/Chapter 0-3](参考教材/chapter_0_introduction/) 的基础教程
3. 参考详细笔记 [note.md](note.md) 深入理解技术细节

### 进阶路径

1. 系统学习 [参考教材/Chapter 0-6](参考教材/chapter_0_introduction/) 的完整教程
2. 深入研读 [note.md](note.md) 的数学推导和算法实现
3. 学习 [参考教材/Chapter 5](参考教材/chapter_5_projects/) 的项目实践

### 强化学习方向路径

1. 先掌握推荐系统基础知识（初学者路径）
2. 学习 [强化学习基本概念](强化学习基本概念.md)，建立RL理论基础
3. 阅读 [00_强化学习推荐系统论文综合总结](00_强化学习推荐系统论文综合总结.md)
4. 逐篇研读 [论文/](论文/) 中的8篇论文，理解不同技术路线
5. 学习 [强化学习在推荐系统中的实现方式](强化学习在推荐系统中的实现方式.md)
6. 学习 [用户行为数据处理](推荐系统用户行为数据的获取与处理.md)
...
- 2026-03-16: 整理仓库目录结构，将教材内容移入参考教材文件夹
